...
class MiBoda 
{
  ...
  public function haceCompras()
  {
    $listaDeCompras = [
      '0' => 'Anillos', // compré yo 
      '1' => 'Floras', // las rosas
      '2' => 'Vestido', // <----- ¿Tienes unas ideas? Tenemos 380, 377, 376, 375, 374, 370, 369, 367, 366, 365, 364, 363, 362, 358, 357, 356, 355, 353, 352, 349, 347, 346, 345, 343, 342, 341, 340, 336, 335, 333, 332, 331, 330, 328, 327, 326, 325, 324, 322, 321, 319, 316, 314, 312, 311, 310, 309, 308, 304, 300, 299, 298, 296, 293, 292, 291, 290, 280 - the end - 278, 277, 272 días hasta nuestra boda
      '3' => 'Traje', // traje negro
